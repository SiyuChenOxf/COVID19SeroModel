...
delta_p<-21        #fixed time lag between test for virus and death(seroversion)
...
folder = paste(folder_strings, sep = "", collapse = "/")
saveRDS(SeroModelTimeVaryingIFR, file=paste(folder,"/SeroModelTimeVaryingIFR_delta_p_21.rds", sep = ""))
