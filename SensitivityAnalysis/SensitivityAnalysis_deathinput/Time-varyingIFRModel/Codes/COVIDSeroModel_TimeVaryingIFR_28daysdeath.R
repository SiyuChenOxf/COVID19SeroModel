...
London_data<-read.csv(paste(folder,"/28London_data.csv", sep = ""),header = TRUE)
NorthWest_data<-read.csv(paste(folder,"/28NorthWest_data.csv", sep = ""),header = TRUE)
YorkshireHumber_data<-read.csv(paste(folder,"/28YorkshireHumber_data.csv", sep = ""),header = TRUE)
SouthWest_data<-read.csv(paste(folder,"/28SouthWest_data.csv", sep = ""),header = TRUE)
EastofEngland_data<-read.csv(paste(folder,"/28EastofEngland_data.csv", sep = ""),header = TRUE)
EastMidlands_data<-read.csv(paste(folder,"/28EastMidlands_data.csv", sep = ""),header = TRUE)
WestMidlands_data<-read.csv(paste(folder,"/28WestMidlands_data.csv", sep = ""),header = TRUE)
NorthEast_data<-read.csv(paste(folder,"/28NorthEast_data.csv", sep = ""),header = TRUE)
SouthEast_data<-read.csv(paste(folder,"/28SouthEast_data.csv", sep = ""),header = TRUE)
...
SeroModelTimeVaryingIFR<-stan(file=paste(folder,"/SeroEstimationTimeVaryingIFR.stan", sep = ""),
                           data = data_sir,
                           iter = niter,
                           chains = chains)
...
folder_strings[length(folder_strings)] = "Data"
folder = paste(folder_strings, sep = "", collapse = "/")
saveRDS(SeroModelTimeVaryingIFR, file=paste(folder,"/SeroModelTimeVaryingIFR_28daysdeath.rds", sep = ""))
