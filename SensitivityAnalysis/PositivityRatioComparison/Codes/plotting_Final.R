...
data7<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_London=c(positivity_London,positivity_LondonNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_London))))
...
data6<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_NorthEastYorshireHumber=c(positivity_NorthEastYorshireHumber,positivity_NorthEastYorshireHumberNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_NorthEastYorshireHumber))))
...
data5<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_NorthWest=c(positivity_NorthWest,positivity_NorthWestNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_NorthWest))))
...
data4<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_SouthWest=c(positivity_SouthWest,positivity_SouthWestNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_SouthWest))))
...
data3<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_SouthEast=c(positivity_SouthEast,positivity_SouthEastNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_SouthEast))))
...
data2<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_Midlands=c(positivity_Midlands,positivity_MidlandsNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_MidlandsNEW))))
...
data1<-data.frame(date=c(as.Date(positivity$date),as.Date(positivity$date)),positivity_EastofEngland=c(positivity_EastofEngland,positivity_EastofEnglandNEW),label=c(rep(c("Pillar 1 & Pillar 2 average","PCR positivity"),each=length(positivity_EastofEnglandNEW))))
